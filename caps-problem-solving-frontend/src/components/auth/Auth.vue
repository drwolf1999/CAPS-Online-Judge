    ...
    <v-container>
        <v-form v-if="LoginMode">
            <v-card flat>
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <Button v-bind:content="`Login`" v-bind:text="true" :disabled="sending" v-on:keyup.enter="LoginUser" v-on:click.native="LoginUser"></Button>
        ...
        <v-form v-else>
            <v-card flat>
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <Button v-bind:content="`Register`" v-bind:text="true" :disabled="sending" v-on:keyup.enter="RegisterUser" v-on:click.native="RegisterUser"></Button>
