...
import Toolbar from "@/components/testcase/TToolbar.vue";
import Tree from "@/components/testcase/TTree.vue";
import List from "@/components/testcase/TList.vue";
import Upload from "@/components/testcase/TUpload.vue";
...
export default {
    ...
    props: {
        ...
        defaultPath: {type: String, default: '1000',},
    },
    data() {
        return {
            loading: 0,
